...
This was especially frustrating when it came to building front-ends with React. So our team set out to bring together some of the ideas and approaches of our favorite open source UI projects into a single library.
